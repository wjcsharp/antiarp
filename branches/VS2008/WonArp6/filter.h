...
#if WONARP
#define FILTER_FRIENDLY_NAME        L"WonARP Firewall"
#define FILTER_UNIQUE_NAME          L"{90D9F45D-B255-4301-A767-5D96972CEF5D}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"WonArp"
//
